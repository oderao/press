<template>
		...
		<div v-if="options" class="space-y-12 pb-[50vh] pt-12">
			...
			<div v-if="serverType === 'dedicated'" class="space-y-12">
				...
				>
					<div class="flex items-center justify-between">
						...
						<div>
							<Button
								link="https://optibizpro.com/pricing#dedicated"
								variant="ghost"
							>
								<template #prefix>
			...
			>
				<FormControl
					...
					:label="`I agree that the laws of the region selected by me shall stand applicable to me and OptiBizPro.`"
				/>
				<ErrorMessage
					class="my-2"
					:message="
	...
	>
		...
		<p>
			...
			<a
				class="underline"
				href="https://optibizpro.com/support"
				target="_blank"
				>contact support</a
			>
			to enable it.
